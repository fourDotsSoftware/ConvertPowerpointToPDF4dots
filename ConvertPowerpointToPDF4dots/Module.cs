...
namespace ConvertPowerpointToPDF4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Convert Powerpoint To PDF 4dots";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/ConvertPowerpointToPDF4dots/";
        public static string HelpURL = "https://www.4dots-software.com/convert-powerpoint-to-pdf/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/convert-powerpoint-to-pdf/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-convert-powerpoint-to-pdf.php";
        public static string VersionURL = "http://cssspritestool.com/versions/convert-powerpoint-to-pdf.txt";

        public static string TipText = TranslateHelper.Translate("Great application to Convert Powerpoint to PDF !");        
