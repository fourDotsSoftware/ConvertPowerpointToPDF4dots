...
{ 
    ...
    {        
        ...
        {
            string msg = "Batch convert Powerpoint to PDF. PPTX to PDF. PPT to PDF.\n\n" +
            "ConvertPowerpointToPDF4dots.exe [[file|directory]]\n" +
            ...
            "/? : show help\n\n\n" +
            "Example :\n" +
            "ConvertPowerpointToPDF4dots.exe \"c:\\documents\\presentation.pptx\"\n\n" +
            "ConvertPowerpointToPDF4dots.exe \"c:\\documents\\presentations\"\n\n"+
            "ConvertPowerpointToPDF4dots.exe /importtext:\"c:\\documents\\list.txt\"\n\n" +
            "ConvertPowerpointToPDF4dots.exe /importexcel:\"c:\\documents\\list.xlsx\"\n\n";
        ...
        public static void ExecuteCommandLine()
        {
            ...
            try
            {
                ...
                */
                ...
                frmMain.Instance.tsbConvertPowerpointToPDF_Click(null, null);
